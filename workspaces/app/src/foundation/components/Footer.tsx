...
export const Footer: React.FC = () => {
  ...
  const handleRequestToTermDialogOpen = async () => {
    const term = await fetch('/const/term').then((r) => r.text());
    updateDialogContent(
  ...
  const handleRequestToContactDialogOpen =  async () => {
    const contact = await fetch('/const/contact').then((r) => r.text());
    updateDialogContent(
  ...
  const handleRequestToQuestionDialogOpen = async () => {
    const question = await fetch('/const/question').then((r) => r.text());
    updateDialogContent(
  ...
  const handleRequestToCompanyDialogOpen = async () => {
    const company = await fetch('/const/company').then((r) => r.text());
    updateDialogContent(
  ...
  const handleRequestToOverviewDialogOpen = async () => {
    const overview = await fetch('/const/overview').then((r) => r.text());
    updateDialogContent(
